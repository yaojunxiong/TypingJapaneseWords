...
Generated: 2026-05-31T07:53:57.296Z

## Overall Status

- Total stages checked: 200 (50 lessons × 4 stages)
- Stages OK: 200 (100.0%)
- Total meta issues: 25
- Total section issues: 0
...
- **v1** (minna.lesson.v1): Lessons 1–38
- **v2** (alternate format): Lessons 39–50

Note: v2 schema uses `id`, `version`, `status`, `lesson`, `topic`, `summary` instead of `schema`, `course`, `lessonNo`, `lessonId`, `subtitle`, `focus`.
...
- Schema: v1
- Meta issues: unexpected section types: mistakes
