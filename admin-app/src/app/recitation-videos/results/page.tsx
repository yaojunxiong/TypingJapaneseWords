  ...
  return (
    <tr style={{ borderBottom: '1px solid #e5e7eb' }}>
      ...
      <td style={{ padding: '8px 10px', fontSize: 13 }}>
        <Link href={`//recitation-videos/results/${r.userId}/lesson/${r.lessonNo}`} style={{ color: '#1d4ed8' }}>
      ...
      <td style={{ padding: '8px 10px' }}>
        <Link
          href={`//recitation-videos/results/${r.userId}/lesson/${r.lessonNo}`}
          className="btn ghost"
  ...
  return (
    <main style={{ paddingBottom: 'calc(140px + env(safe-area-inset-bottom, 0px))' }}>
      ...
      <p style={{ textAlign: 'center', marginTop: 20 }}>
        <Link className="btn ghost" href="/recitation-videos">
          {tr(lang, '← 返回', '← Back')}
        </Link>
      </p>
    </main>
