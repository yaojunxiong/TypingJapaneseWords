    ...
    return (
      <main>
        ...
        <section className="card">
          ...
          <p><Link className="btn ghost" href="/recitation-videos/results">← 返回</Link></p>
        </section>
      </main>
    )
  }
    ...
    <main style={{ paddingBottom: 'calc(140px + env(safe-area-inset-bottom, 0px))' }}>
      ...
      <section className="card" style={{ marginBottom: 12 }}>
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
          ...
          />
          <Link
            href={`//recitation-videos/projects/new?userId=${userId}&lessonNo=${lessonNo}${bestSelection ? `&bestSelectionId=${bestSelection.id}` : ''}`}
            className="btn"
      ...
      <p style={{ textAlign: 'center', marginTop: 20 }}>
        <Link className="btn ghost" href="/recitation-videos/results">
