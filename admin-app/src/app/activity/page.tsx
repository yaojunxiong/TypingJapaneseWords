...
function WorkflowStatusCell({ event, lang }: { event: ActivityRow; lang: Lang }) {
  if (event.workflow_instance_id) {
    return (
      <Link
        href={`//workflows/study-visitor/${event.workflow_instance_id}/flowchart`}
        className="pillLink"
          ...
          <section className="card">
            ...
            <form method="get" style={{ display: 'grid', gap: 12, gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', alignItems: 'end' }}>
              ...
              <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                ...
                <Link className="btn ghost" href="/activity">{tr(lang, '清除', 'Clear')}</Link>
              </div>
            </form>
          </section>
          ...
          <section className="card" style={{ overflowX: 'auto' }}>
            ...
            <div>
              ...
              <p style={{ marginTop: 12 }}>
                <Link className="btn ghost" href="/activity">
