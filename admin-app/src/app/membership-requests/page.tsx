    ...
    return (
      <main>
        ...
        <section className="card">
          ...
          <p>
            <Link className="btn ghost" href="/">{tr(lang, '返回后台首页', 'Back to Admin')}</Link>
          </p>
        </section>
    ...
    return (
      <main>
        ...
        <section className="card">
          ...
          <p><Link href="/">{tr(lang, '返回后台首页', 'Back')}</Link></p>
        </section>
      </main>
    )
  }
  ...
  return (
    <main>
      ...
      <section className="card" style={{ overflowX: 'auto' }}>
        ...
        <p className="small" style={{ marginTop: 12 }}><Link href="/">{tr(lang, '← 返回后台首页', '← Back to Admin')}</Link></p>
