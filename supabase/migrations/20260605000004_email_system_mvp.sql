-- Configurable email system MVP for forum review notifications.
-- First phase: create configurable settings/templates/logs, but only write logs.
-- Run this once after 20260605000001_forum_review_flow.sql.
...
insert into public.email_settings (id, enabled, provider)
values (1, true, 'mock')
