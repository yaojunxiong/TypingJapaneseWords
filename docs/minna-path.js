...
(function(){
  ...
  var LESSONS = {
    1:{zh:'自我介绍',en:'Self-introduction'},
    2:{zh:'这个是什么',en:'What is this?'},
    3:{zh:'这里是哪里',en:'Where is here?'},
    4:{zh:'时间表达',en:'Time expressions'},
    5:{zh:'移动与交通',en:'Movement and transport'},
    6:{zh:'动词ます形',en:'Masu-form verbs'},
    7:{zh:'授受基础',en:'Giving basics'},
    8:{zh:'形容词',en:'Adjectives'},
    9:{zh:'喜欢与能力',en:'Likes and skills'},
    10:{zh:'存在句',en:'Existence sentences'},
    11:{zh:'数量表达',en:'Quantity expressions'},
    12:{zh:'过去与比较',en:'Past and comparison'},
    13:{zh:'想要与目的',en:'Wants and purpose'},
    14:{zh:'て形基础',en:'Te-form basics'},
    15:{zh:'许可与禁止',en:'Permission and prohibition'},
    16:{zh:'连接动作',en:'Connecting actions'},
    17:{zh:'ない形',en:'Nai-form'},
    18:{zh:'辞书形',en:'Dictionary form'},
    19:{zh:'た形',en:'Ta-form'},
    20:{zh:'普通形',en:'Plain form'},
    21:{zh:'观点引用',en:'Opinions and quotes'},
    22:{zh:'定语从句',en:'Relative clauses'},
    23:{zh:'条件与时间',en:'Condition and time'},
    24:{zh:'授受进阶',en:'Giving advanced'},
    25:{zh:'条件句',en:'Conditionals'},
    26:{zh:'说明与求助',en:'Explaining and asking help'},
    27:{zh:'可能形',en:'Potential form'},
    28:{zh:'一边与并列',en:'While and listing'},
    29:{zh:'状态与完成',en:'State and completion'},
    30:{zh:'准备与状态',en:'Preparation and setup'},
    31:{zh:'意向与计划',en:'Intentions and plans'},
    32:{zh:'建议与推量',en:'Advice and guess'},
    33:{zh:'命令与传达',en:'Commands and reports'},
    34:{zh:'按指示进行',en:'Follow instructions'},
    35:{zh:'条件表达进阶',en:'Advanced conditionals'},
    36:{zh:'目标与习惯',en:'Goals and habits'},
    37:{zh:'被动语态',en:'Passive voice'},
    38:{zh:'名词化表达',en:'Nominalization'},
    39:{zh:'原因与理由',en:'Cause and reason'},
    40:{zh:'疑问嵌套',en:'Embedded questions'},
    41:{zh:'授受敬语',en:'Honorific giving'},
    42:{zh:'目的与用途',en:'Purpose and usage'},
    43:{zh:'样态推测',en:'Appearance inference'},
    44:{zh:'程度与易难',en:'Degree and ease'},
    45:{zh:'假设与逆接',en:'Cases and contrast'},
    46:{zh:'阶段与推断',en:'Stages and expectation'},
    47:{zh:'传闻与推测',en:'Hearsay and inference'},
    48:{zh:'使役语态',en:'Causative form'},
    49:{zh:'尊敬语',en:'Respectful speech'},
    50:{zh:'谦让语',en:'Humble speech'}
  };
  var DATA = {};
  for(var i=1;i<=50;i++){
    var row = LESSONS[i] || {zh:'第 '+i+' 课',en:'Lesson '+i};
    DATA[i] = {
      zh:{unit:'第 '+i+' 课',title:row.zh},
      en:{unit:'Lesson '+i,title:row.en}
    };
  }
  var STAGES = [
